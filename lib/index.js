...
exports.required = (value = true) => new GenericValidator()
    .check(checks.required(), { optional: !value })

exports.forbidden = (value = true) => new GenericValidator()
    .check(checks.forbidden(), { optional: !value })

exports.boolean = () => new GenericValidator().check(checks.boolean())
exports.oneOf = values => new GenericValidator().check(checks.oneOf(values))
