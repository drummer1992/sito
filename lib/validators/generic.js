...
module.exports = class GenericValidator {
  ...
  validate(payload, customOptions = {}) {
    return require('../').validate(this, payload, customOptions)
  }

  assert(payload, customOptions = {}) {
    return require('../').assert(this, payload, customOptions)
  }

  assertBulk(payload, customOptions = {}) {
    return require('../').assertBulk(this, payload, customOptions)
  }
