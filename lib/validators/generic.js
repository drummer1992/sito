...
module.exports = class GenericValidator {
  ...
  required(enabled = true) {
    return this.check({ ...checks.required(), optional: false, enabled })
  }

  forbidden(enabled = true) {
    return this.check({ ...checks.forbidden(), optional: false, enabled })
  }

  exists(enabled = true) {
    return this.check({ ...checks.exists(), optional: false, enabled })
  }
