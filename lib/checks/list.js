...
const stringPredicates = require('../utils/predicates/string')
...
exports.string.uuid4 = () => ({
  validate : value => stringPredicates.isUuid4(value),
  message: path => `${path} is not an uuid4`,
})
