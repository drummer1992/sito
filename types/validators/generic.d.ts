...
import {CheckDto, Mapper, Message, ForbiddenOptions, TransformOptions, OnErrorMapper} from "../interfaces";
...
declare class GenericValidator {
    ...
    transform(mapper: Mapper | OnErrorMapper, options?: TransformOptions): this
